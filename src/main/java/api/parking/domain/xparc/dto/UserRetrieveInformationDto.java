...
public class UserRetrieveInformationDto {
    ...
    public void setPostPaymentAllowed(boolean postPaymentAllowed) {
        isPostPaymentAllowed = postPaymentAllowed;
    }
    ...
    public void setWalletPaymentAllowed(boolean walletPaymentAllowed) {
        isWalletPaymentAllowed = walletPaymentAllowed;
    }
